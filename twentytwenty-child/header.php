...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-B7QX8C4E6L"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-B7QX8C4E6L');
</script>
...
.banner-info h1 {
   ...
   .banner-wrap {
    background: url(/wp-content/uploads/2020/09/banner.png)no-repeat left;
    padding-top: 86px;
    padding-bottom: 86px;
...
body{background:<?php echo $allthemeoptions['innerbgcolor']; ?>; font-family: 'Raleway',sans-serif !important; }
<?php }else{ ?>
body{background:<?php echo $allthemeoptions['themecolor1']; ?>; font-family: 'Raleway',sans-serif !important; }
<?php } ?>
...
if(response=="yes"){
	...
	jQuery.post(ajax_url, { 'action': 'custom_userregister','registername': registername,'registerlawfirm': registerlawfirm, 'registeremail': registeremail, 'registerlawphone': registerlawphone, 'registerpass': registerpass   }, function(response) {
		//alert(response);
		if(response=="yes"){
	jQuery("#register .loginboxcontainer").html('<div class="registersuccessfull">Thank you for registering! <br>As soon as your account is checked and verified, <br>you will be able to login to our portal. <br>We will inform you through email.</div>');

		}else if(response=="yes approved"){
			jQuery("#register .loginboxcontainer").html('<div class="registersuccessfull">Thank you for registering!<br> You are pre-approved for portal access,<br> so you can login now.</div>');
    ...
    <div class="banner-wrap">
        <div class="sitecontainer">
            <div class="banner-info">
                <h1>TRUCK ACCIDENT LITIGATION RESOURCE CENTER </h1>
                <p class="bold-text">Welcome to our online resource center for lawyers litigating truck accidents on behalf of plaintiffs nationwide. We hope you find information that is useful to your case, or to your education in litigating these cases. </p>
                <p class="bold-ccc">Because of their size and weight for starters, trucks are a real danger to drivers and vehicle occupants on American highways. From negligent hiring and negligent practices by trucking companies, to product defects within the trucks themselves, our firm has successfully taken on these cases for more than 20 years. We are always happy to share some of our best practices that we've learned along the way, or if you'd like to talk with us about your trucking case, call any time at the number above or by <span class="email-us"><a href="mailto:contact@lelaw.com" style="color: #782113;">emailing us here</a></span> </p>
            </div>
        </div>
    </div>
<?php } ?>
